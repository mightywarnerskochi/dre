<?php
$page_title = 'The Gate Residence 2 | Distinguished Real Estate';
$page_key = 'properties';
$body_class = 'property-details-page';
$meta_description = 'The Gate Residence 2 — premium apartment for rent in Dubai. View photos, amenities, location, and speak with our property consultant.';
$style_version = '34';
...
?>
    <section class="banner banner--page banner--page--listing position-relative" aria-label="Page header">
        ...
        <div class="banner--page__content">
            <div class="container-ctn">
                <h1 class="banner--page__title">The Gate Residence 2</h1>
                <ol class="breadcrumb-minimal" aria-label="Breadcrumb">
                    ...
                    <li class="breadcrumb-minimal__sep" aria-hidden="true">/</li>
                    <li class="breadcrumb-minimal__current" aria-current="page">The Gate Residence 2</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="container-fluid property-detail-gallery-fluid p-0 overflow-hidden">
                <div class="property-detail-gallery__viewport">
                    <div class="property-detail-gallery__slider js-property-detail-slider">
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--portrait">
                            <img src="public/images/properties-details/1.jpg" alt="Bathroom" width="520" height="780" loading="lazy">
                        </div>
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--wide">
                            <img src="public/images/properties-details/2.jpg" alt="Living and dining area" width="960" height="600" loading="lazy">
                        </div>
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--landscape">
                            <img src="public/images/properties-details/3.jpg" alt="Bedroom" width="880" height="560" loading="lazy">
                        </div>
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--wide">
                            <img src="public/images/properties-details/1.jpg" alt="Living room with floor-to-ceiling windows" width="960" height="600" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
  ...
  <path d="M15 11.9998L16.644 10.3558C16.7564 10.2433 16.8898 10.1541 17.0367 10.0932C17.1836 10.0323 17.341 10.001 17.5 10.001C17.659 10.001 17.8164 10.0323 17.9633 10.0932C18.1102 10.1541 18.2436 10.2433 18.356 10.3558L21 12.9998" stroke="#2F3F58" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="d-flex align-items-start property-detail-intro justify-content-between">
                    <div class="property-detail-intro__left">
                        <div class="property-detail-badges">
                            <span class="property-detail-badge property-detail-badge--apartment">Apartment</span>
                            <span class="property-detail-badge property-detail-badge--outline">Rentals</span>
                        </div>
                        <h2 class="property-detail-title">The Gate Residence 2</h2>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <span>Dubai Al Ain Road, Opposite Zayed University and Silicon Oasis, Dubai, Dubai Land</span>
                        </p>
                        ...
                        <div class="property-detail-price-wrap">
                            <p class="property-detail-price">45,000 د.إ</p>
                        </div>
                    </div>
                                ...
                                <div class="property-detail-agent__header">
                                    <div class="property-detail-agent__profile">
                                        <div class="property-detail-agent__avatar">
                                            <img src="public/images/chat.png" alt="" width="64" height="64" loading="lazy">
                                        </div>
                                        <div class="property-detail-agent__intro">
                                            <p class="property-detail-agent__name">Sean</p>
                                            <p class="property-detail-agent__role">Leasing Executive</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="property-detail-agent__body">
                                    <ul class="property-detail-agent__details list-unstyled">
                                        <li><span class="property-detail-agent__detail-label">Experience :</span> <span class="property-detail-agent__detail-value">6+ years of Experience</span></li>
                                        <li><span class="property-detail-agent__detail-label">Languages :</span> <span class="property-detail-agent__detail-value">English, Arabic</span></li>
                                    </ul>
                                    <div class="property-detail-agent__actions">
                                        <div class="property-detail-agent__actions-row">
                                            ...
                                            <a class="property-detail-btn property-detail-btn--soft property-detail-btn--row" href="tel:+97143438302">Call Now</a>
                                            <a class="property-detail-btn property-detail-btn--outline property-detail-btn--row" href="https://wa.me/97143438302" target="_blank" rel="noopener noreferrer">Whatsapp</a>
                                        </div>
                                    </div>
                                    <a class=" property-detail-agent__link property-detail-agent__link--external" href="#">
                                        View Profile
                                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                                        <path d="M8.48508 16.9705L16.9704 8.48526M16.9704 8.48526H10.6064M16.9704 8.48526V14.8492" stroke="#2A559C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </a>
                                </div>
                            </div>
        ...
        <div class="container-ctn property-detail-body justify-content-between">
            <div class="property-detail-body__main _left_col">
                <section class="property-detail-section" aria-labelledby="pd-desc-heading">
                    <h3 id="pd-desc-heading" class="property-detail-section__title">Description</h3>
                    <div class="property-detail-section__text">
                        <p>Welcome to a vibrant community where modern living meets convenience. This thoughtfully designed development offers a balanced lifestyle with lush green spaces, retail outlets, dining options, and essential services all within easy reach. Whether you are a young professional, a growing family, or someone seeking a peaceful retreat, this community caters to diverse needs with world-class amenities and a welcoming atmosphere.</p>
                    </div>
                </section>

                <section class="property-detail-section" aria-labelledby="pd-access-heading">
                    <h3 id="pd-access-heading" class="property-detail-section__title">Easy Access To</h3>
                    <div class="property-detail-access">
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/lets-icons_road-alt.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Academic City  7 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/mynaui_plane.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai International Airport (DXB): 17 min</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/icon-park-outline_shopping-mall.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai Outlet Mall 8 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/fluent-emoji-high-contrast_man-playing-handball.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai Rugby Sevens 10 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/material-symbols_hiking.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Al Qudra Cycling Track 13 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/streamline-cyber_building-13.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Expo City Dubai 15 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img src="public/images/properties-details/icons/solar_city-linear.png" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai Hills Mall 18 mins</span>
                        </div>
                    </div>
                </section>

                <section class="property-detail-section" aria-labelledby="pd-specs-heading">
                    <h3 id="pd-specs-heading" class="property-detail-section__title">Property Details</h3>
                    <div class="property-detail-specs property-detail-specs--cards">
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/solar_tag-price-linear.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Property Id:</p>
                            <p class="property-detail-specs__value">19912</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/solar_hand-money-outline.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Price</p>
                            <p class="property-detail-specs__value">45,000 د.إ</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/gis_square-pt.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Property Size</p>
                            <p class="property-detail-specs__value">580 ft²</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/cil_bathroom.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Bathroom</p>
                            <p class="property-detail-specs__value">1</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/mynaui_calendar.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Year Built</p>
                            <p class="property-detail-specs__value">2021-06-30</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/fluent_building-32-regular.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Direct from owner</p>
                            <p class="property-detail-specs__value">Studio</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img src="public/images/properties-details/icons/ph_hand-deposit.png" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Security Deposit</p>
                            <p class="property-detail-specs__value">Minimum AED 3,000</p>
                        </div>
                    </div>
                </section>

                <section class="property-detail-section" aria-labelledby="pd-features-heading">
                    ...
                    <div class="property-detail-icon-grid">
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/tabler_device-cctv.png" alt="" width="26" height="26" loading="lazy"></span>
                            <span>4-hour security</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/bx_car.png" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Car Parking</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/iconoir_gym.png" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Gym</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/solar_swimming-outline.png" alt="" width="26" height="26" loading="lazy"></span>
                    ...
                    <div class="property-detail-icon-grid property-detail-icon-grid--cols3">
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/hugeicons_car-parking-01.png" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Covered Parking</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/solar_hand-money-outline.png" alt="" width="26" height="26" loading="lazy"></span>
                            <span>No Commission</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img src="public/images/properties-details/icons/hugeicons_location-star-01.png" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Prime Location</span>
                        </div>
                    </div>
                </section>
                <div class=" property-detail-calc-outer">
                        ...
                        <div class="property-detail-calc__donut-wrap">
                            <div class="property-detail-calc__donut js-calc-donut" role="img" aria-label="Payment breakdown chart">
                                <div class="property-detail-calc__donut-label">
                                    <p class="property-detail-calc__donut-value js-calc-monthly">174.47 د.إ</p>
                        ...
                        <div class="property-detail-calc__panel">
                            <div class="property-detail-calc__fields property-detail-calc__fields--grid">
                                <div class="property-detail-calc__field">
                                    ...
                                    <input id="calc_price" name="calc_price" type="number" inputmode="decimal" min="0" step="100" value="45000">
                                </div>
                                ...
                                <div class="property-detail-calc__field property-detail-calc__field--readonly">
                                    ...
                                    <p class="property-detail-calc__readonly-value js-calc-pi-monthly">174.47 د.إ</p>
                                </div>
                                <div class="property-detail-calc__field">
            ...
            <aside class="property-detail-body__map" aria-label="Location map">
                <div class="property-detail-map-card position-relative">
                    ...
                    <div class="property-detail-map-card__map-panels js-map-map-panels" aria-live="polite">
                        <div id="map-panel-schools" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-schools" hidden>
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" src="public/images/properties-details/map.jpg" alt="Map showing schools near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                ...
                                <div class="property-detail-map-card__layers">
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--school" style="left: 22%; top: 42%;" aria-label="Gems Wellington Academy — Silicon Oasis, ~6 min" data-poi-label="Wellington Academy"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--school" style="left: 68%; top: 55%;" aria-label="Indian International School — ~8 min" data-poi-label="Indian Int'l School"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--school" style="left: 45%; top: 72%;" aria-label="The Kindergarten Starters — ~5 min" data-poi-label="Kindergarten Starters"></button>
                                </div>
                                <div class="property-detail-map-card__popup js-map-popup" role="dialog" aria-label="Property summary">
                                    <button type="button" class="property-detail-map-card__popup-close js-map-popup-close" aria-label="Close">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M18 6L6 18M6 6L18 18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                                        </svg>
                                    </button>
                                    <img class="property-detail-map-card__popup-thumb" src="public/images/properties-details/1.jpg" alt="" width="64" height="64" loading="lazy">
                                    <div class="property-detail-map-card__popup-body">
                                        <p class="property-detail-map-card__popup-title">The Gate Residence 2</p>
                                        <p class="property-detail-map-card__popup-price">45,000 د.إ</p>
                                        <p class="property-detail-map-card__popup-meta">1 BA 580 ft²</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="map-panel-hospitals" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-hospitals" hidden>
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" src="public/images/properties-details/map.jpg" alt="Map showing hospitals near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                    <span class="property-detail-map-card__pin-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M3 10.5L12 3L21 10.5V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V10.5Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="property-detail-map-card__layers">
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--hospital" style="left: 58%; top: 32%;" aria-label="NMC Royal Hospital — ~12 min" data-poi-label="NMC Royal"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--hospital" style="left: 35%; top: 58%;" aria-label="Aster Clinic — ~7 min" data-poi-label="Aster Clinic"></button>
                                </div>
                                <div class="property-detail-map-card__popup js-map-popup" role="dialog" aria-label="Property summary">
                                    <button type="button" class="property-detail-map-card__popup-close js-map-popup-close" aria-label="Close">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                    ...
                                    <img class="property-detail-map-card__popup-thumb" src="public/images/properties-details/1.jpg" alt="" width="64" height="64" loading="lazy">
                                    <div class="property-detail-map-card__popup-body">
                                        <p class="property-detail-map-card__popup-title">Hospitals</p>
                                        <p class="property-detail-map-card__popup-price">45,000 د.إ</p>
                                        <p class="property-detail-map-card__popup-meta">1 BA 580 ft²</p>
                                    </div>
                                </div>
                        ...
                        <div id="map-panel-restaurants" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-restaurants" hidden>
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" src="public/images/properties-details/map.jpg" alt="Map showing restaurants near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                    <span class="property-detail-map-card__pin-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M3 10.5L12 3L21 10.5V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V10.5Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="property-detail-map-card__layers">
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--food" style="left: 48%; top: 28%;" aria-label="Arabian Tea House — ~4 min" data-poi-label="Arabian Tea House"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--food" style="left: 72%; top: 48%;" aria-label="Shake Shack — ~6 min" data-poi-label="Shake Shack"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--food" style="left: 28%; top: 68%;" aria-label="Zaroob — ~5 min" data-poi-label="Zaroob"></button>
                                </div>
                                <div class="property-detail-map-card__popup js-map-popup" role="dialog" aria-label="Property summary">
                                    <button type="button" class="property-detail-map-card__popup-close js-map-popup-close" aria-label="Close">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                    ...
                                    <img class="property-detail-map-card__popup-thumb" src="public/images/properties-details/1.jpg" alt="" width="64" height="64" loading="lazy">
                                    <div class="property-detail-map-card__popup-body">
                                        <p class="property-detail-map-card__popup-title">Restaurants</p>
                                        <p class="property-detail-map-card__popup-price">45,000 د.إ</p>
                                        <p class="property-detail-map-card__popup-meta">1 BA 580 ft²</p>
                                    </div>
                                </div>
                        ...
                        <div id="map-panel-attractions" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-attractions">
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" src="public/images/properties-details/map.jpg" alt="Map showing attractions near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                    <span class="property-detail-map-card__pin-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M3 10.5L12 3L21 10.5V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V10.5Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="property-detail-map-card__layers">
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--attraction" style="left: 55%; top: 25%;" aria-label="Dubai Silicon Oasis HQ — ~3 min" data-poi-label="DSO HQ"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--attraction" style="left: 18%; top: 52%;" aria-label="Silicon Park — ~4 min" data-poi-label="Silicon Park"></button>
                                    <button type="button" class="property-detail-map-card__poi property-detail-map-card__poi--attraction" style="left: 78%; top: 62%;" aria-label="Community park — ~2 min" data-poi-label="Community Park"></button>
                                </div>
                                <div class="property-detail-map-card__popup js-map-popup" role="dialog" aria-label="Property summary">
                                    <button type="button" class="property-detail-map-card__popup-close js-map-popup-close" aria-label="Close">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                    ...
                                    <img class="property-detail-map-card__popup-thumb" src="public/images/properties-details/1.jpg" alt="" width="64" height="64" loading="lazy">
                                    <div class="property-detail-map-card__popup-body">
                                        <p class="property-detail-map-card__popup-title">Attractions</p>
                                        <p class="property-detail-map-card__popup-price">45,000 د.إ</p>
                                        <p class="property-detail-map-card__popup-meta">1 BA 580 ft²</p>
                                    </div>
                                </div>
                    ...
                    <div class="property-detail-map-card__tabs-outer">
                        <div class="property-detail-map-card__tabs js-property-map-tabs" role="tablist" aria-label="Nearby places">
                            <button type="button" class="property-detail-map-card__tab" role="tab" aria-selected="false" aria-controls="map-panel-schools" id="map-tab-schools" tabindex="-1">Schools</button>
                            <button type="button" class="property-detail-map-card__tab" role="tab" aria-selected="false" aria-controls="map-panel-hospitals" id="map-tab-hospitals" tabindex="-1">Hospitals</button>
                            <button type="button" class="property-detail-map-card__tab" role="tab" aria-selected="false" aria-controls="map-panel-restaurants" id="map-tab-restaurants" tabindex="-1">Restaurants</button>
                            <button type="button" class="property-detail-map-card__tab is-active" role="tab" aria-selected="true" aria-controls="map-panel-attractions" id="map-tab-attractions" tabindex="0">Attractions</button>
                        </div>
                    </div>
                </div>
            </aside>
        ...
        <section class="property-detail-similar commonPadding-120 pb-0" aria-labelledby="similar-listings-heading">
            <div class="container-ctn">
                ...
                <div class="property-detail-similar__slider-outer">
                    <div class="js-property-detail-similar-slider property-detail-similar__slider">
                        <?php
                        $similar = [
                            ['t' => 'The Gate Residence 2', 'loc' => 'Dubai Al Ain Road, Silicon Oasis, Dubai', 'price' => '55,000', 'img' => '1', 'photos' => 13, 'bed' => 1, 'bath' => 1, 'sqft' => '712'],
                            ['t' => 'Marina View Residences', 'loc' => 'Dubai Marina, Dubai', 'price' => '110,000', 'img' => '2', 'photos' => 18, 'bed' => 2, 'bath' => 2, 'sqft' => '1,015'],
                            ['t' => 'Majestic Tower', 'loc' => 'Al Abraj Street Business Bay, Dubai', 'price' => '92,000', 'img' => '1', 'photos' => 13, 'bed' => 1, 'bath' => 1, 'sqft' => '890'],
                            ['t' => 'Palm Breeze Villa', 'loc' => 'Palm Jumeirah, Dubai', 'price' => '185,000', 'img' => '2', 'photos' => 24, 'bed' => 3, 'bath' => 3, 'sqft' => '2,200'],
                            ['t' => 'Creek Harbour Loft', 'loc' => 'Dubai Creek Harbour, Dubai', 'price' => '78,000', 'img' => '1', 'photos' => 16, 'bed' => 2, 'bath' => 2, 'sqft' => '1,240'],
                            ['t' => 'Downtown Sky Suite', 'loc' => 'Downtown Dubai, Dubai', 'price' => '132,000', 'img' => '2', 'photos' => 21, 'bed' => 2, 'bath' => 2, 'sqft' => '1,180'],
                        ];
                        foreach ($similar as $p) :
                            $img = 'public/images/properties/' . $p['img'] . '.jpg';
                        ?>
                        <div class="property-detail-similar__slide">
                            <article class="property-card property-card--listing">
                                ...
                                <div class="property-card__inner">
                                    <div class="property-card__media">
                                        ...
                                        <?php for ($i = 0; $i < 6; $i++) : ?>
                                        <div class="property-card__media-slide">
                                            <picture>
                                                <img src="<?php echo htmlspecialchars($img); ?>" alt="<?php echo htmlspecialchars($p['t']); ?>" width="427" height="260" loading="lazy">
                                            </picture>
                                        </div>
                                        <?php endfor; ?>
                                    ...
                                    <div class="property-card__body">
                                        <h3 class="property-card__title"><?php echo htmlspecialchars($p['t']); ?></h3>
                                        <p class="property-card__location">
                                            ...
                                            <span><?php echo htmlspecialchars($p['loc']); ?></span>
                                        </p>
                                        <div class="property-card__meta property-card__meta--similar">
                                            <div class="property-card__price-row">
                                                <div class="property-card__price"><?php echo htmlspecialchars($p['price']); ?> د.إ</div>
                                            </div>
                                        ...
                                        <div class="property-details">
                                            <div class="property-details__item">
                                                ...
                                                <span><?php echo (int) $p['bed']; ?> Bedroom<?php echo (int) $p['bed'] === 1 ? '' : 's'; ?></span>
                                            </div>
                                            <div class="property-details__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                                ...
                                                <span><?php echo (int) $p['bath']; ?> Bathroom<?php echo (int) $p['bath'] === 1 ? '' : 's'; ?></span>
                                            </div>
                                            <div class="property-details__item">
                                                ...
                                                <span><?php echo htmlspecialchars($p['sqft']); ?> ft²</span>
                                            </div>
                                        </div>
                                        <div class="property-card__footer property-card__footer--actions-only">
                                            <div class="property-card__actions">
                                                ...
                                                <a class="property-btn property-btn--outline" href="tel:+97143438302">Call Now</a>
                                                <a class="property-btn property-btn--outline" href="https://wa.me/97143438302" target="_blank" rel="noopener noreferrer">Whatsapp</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
