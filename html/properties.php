                ...
                <div class="properties-listing__search banner-search p-0 js-listing-search-panel">
                    <form action="#" class="search-form search-form--listing">
                        <div class="search-field search-field--location">
                            ...
                            <input type="text" name="location" id="listingLocationInput" placeholder="Location" autocomplete="address-level2">
                            <div class="search-results-dropdown" id="listingSearchResults">
                                ...
                                <div class="search-results-list custom-scrollbar">
                                    <div class="search-results-item">
                                        ...
                                        <div class="search-results-content">
                                            <div class="search-results-name">Dubai Marina</div>
                                            <div class="search-results-city">Dubai</div>
                                        </div>
                                    </div>
                                    <div class="search-results-item">
                                        <div class="search-results-icon">
                                        ...
                                        <div class="search-results-content">
                                            <div class="search-results-name">Downtown Dubai</div>
                                            <div class="search-results-city">Dubai</div>
                                        </div>
                                    </div>
                                    <div class="search-results-item">
                                        ...
                                        <div class="search-results-content">
                                            <div class="search-results-name">Business Bay</div>
                                            <div class="search-results-city">Dubai</div>
                                        </div>
                                    </div>
                                    <div class="search-results-item">
                                        ...
                                        <div class="search-results-content">
                                            <div class="search-results-name">Palm Jumeirah</div>
                                            <div class="search-results-city">Dubai</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown-section">
                                    ...
                                    <div class="option-buttons" data-type="bedrooms">
                                        <label class="custom-check-btn"><input type="checkbox"
                                                ...
                                                id="pl-bed-studio">Studio</label>
                                        <label class="custom-check-btn"><input type="checkbox"
                                                class="btn-check bed-check" value="1" id="pl-bed-1">1</label>
                                        <label class="custom-check-btn"><input type="checkbox"
                                                class="btn-check bed-check" value="2" id="pl-bed-2">2</label>
                                        <label class="custom-check-btn"><input type="checkbox"
                                                class="btn-check bed-check" value="3" id="pl-bed-3">3</label>
                                    </div>
                                </div>
                                <div class="dropdown-section">
                                    ...
                                    <div class="option-buttons" data-type="bathrooms">
                                        <label class="custom-check-btn"><input type="checkbox"
                                                class="btn-check bath-check" value="1" id="pl-bath-1">1</label>
                                        <label class="custom-check-btn"><input type="checkbox"
                                                class="btn-check bath-check" value="2" id="pl-bath-2">2</label>
                                        <label class="custom-check-btn"><input type="checkbox"
                                                class="btn-check bath-check" value="3" id="pl-bath-3">3</label>
                                    </div>
                                </div>
                                <div class="dropdown-footer">
                        ...
                        <div class="search-field dropdown-field dropdown search-field--filter" id="categoriesField">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                fill="none">
                                <path
                                    d="M12.75 7.5C13.9926 7.5 15 6.49264 15 5.25C15 4.00736 13.9926 3 12.75 3C11.5074 3 10.5 4.00736 10.5 5.25C10.5 6.49264 11.5074 7.5 12.75 7.5Z"
                                    stroke="#4B5C77" stroke-width="1.125" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M5.25 15C6.49264 15 7.5 13.9926 7.5 12.75C7.5 11.5074 6.49264 10.5 5.25 10.5C4.00736 10.5 3 11.5074 3 12.75C3 13.9926 4.00736 15 5.25 15Z"
                                    stroke="#4B5C77" stroke-width="1.125" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M10.5 10.5H15V14.25C15 14.4489 14.921 14.6397 14.7803 14.7803C14.6397 14.921 14.4489 15 14.25 15H11.25C11.0511 15 10.8603 14.921 10.7197 14.7803C10.579 14.6397 10.5 14.4489 10.5 14.25V10.5ZM3 3H7.5V6.75C7.5 6.94891 7.42098 7.13968 7.28033 7.28033C7.13968 7.42098 6.94891 7.5 6.75 7.5H3.75C3.55109 7.5 3.36032 7.42098 3.21967 7.28033C3.07902 7.13968 3 6.94891 3 6.75V3Z"
                                    stroke="#4B5C77" stroke-width="1.125" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                            <button type="button" class="dropdown-trigger bg-transparent border-0 w-100 text-start"
                        ...
                        <div class="search-field dropdown-field dropdown search-field--filter" id="priceField">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                fill="none">
                                <path
                                    d="M3.5459 12.1029C2.38715 10.9434 1.8074 10.3644 1.59215 9.61218C1.37615 8.85993 1.56065 8.06118 1.92965 6.46443L2.1419 5.54343C2.45165 4.19943 2.6069 3.52743 3.06665 3.06693C3.5264 2.60643 4.19915 2.45193 5.54315 2.14218L6.46415 1.92918C8.06165 1.56093 8.85965 1.37643 9.6119 1.59168C10.3641 1.80768 10.9431 2.38743 12.1019 3.54618L13.4744 4.91868C15.4926 6.93618 16.4999 7.94418 16.4999 9.19668C16.4999 10.4499 15.4919 11.4579 13.4751 13.4747C11.4576 15.4922 10.4496 16.5002 9.1964 16.5002C7.9439 16.5002 6.93515 15.4922 4.9184 13.4754L3.5459 12.1029Z"
                                    stroke="#4B5C77" stroke-width="1.125" />
                                <path
                                    d="M11.5443 11.5443C11.983 11.1041 12.0422 10.4516 11.6762 10.0848C11.3102 9.71806 10.657 9.77806 10.2175 10.2176C9.77875 10.6571 9.1255 10.7163 8.7595 10.3503C8.3935 9.98431 8.45275 9.33106 8.89225 8.89231M8.89225 8.89231L8.62675 8.62681M8.89225 8.89231C9.1405 8.64331 9.457 8.51731 9.75175 8.51956M11.809 11.8091L11.5435 11.5436C11.2435 11.8443 10.8422 11.9673 10.5017 11.8968"
                                    stroke="#4B5C77" stroke-width="1.125" stroke-linecap="round" />
                                <path
                                    d="M7.51792 7.72082C8.1037 7.13503 8.1037 6.18528 7.51792 5.5995C6.93213 5.01371 5.98238 5.01371 5.3966 5.5995C4.81081 6.18528 4.81081 7.13503 5.3966 7.72082C5.98238 8.3066 6.93213 8.3066 7.51792 7.72082Z"
                                    stroke="#4B5C77" stroke-width="1.125" />
                            </svg>
                            <button type="button" class="dropdown-trigger bg-transparent border-0 w-100 text-start"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="price-range-slider-container">
                                    ...
                                    <div class="price-range-slider-display">
                                        <div class="price-range-slider-display__field">
                                            <input type="text" class="js-slider-min-input" value="0"
                                                aria-label="Minimum price" inputmode="numeric">
                                            <span class="currency">AED</span>
                                        </div>
                                        <span class="slider-sep">-</span>
                                        <div class="price-range-slider-display__field">
                                            <input type="text" class="js-slider-max-input" value="1,000,000"
                                                aria-label="Maximum price" inputmode="numeric">
                                            <span class="currency">AED</span>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container-ctn">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="listing-toolbar">
                <a href="https://www.google.com/maps/search/?api=1&amp;query=Dubai+UAE+properties"
                    class="listing-toolbar__btn" target="_blank" rel="noopener noreferrer">
                ...
                <div class="dropdown">
                    <button type="button" class="listing-toolbar__btn dropdown-toggle" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            aria-hidden="true">
                            <path d="M4 6H20M8 12H16M10 18H14" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" />
                            <path d="M6 4V8M18 10V14M12 16V20" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" />
                        </svg>
                        Sort
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end custom-dropdown-menu custom-dropdown-menu--toolbar">
                        <li><button type="button" class="dropdown-item ">Newest first</button></li>
                        <li><button type="button" class="dropdown-item">Price: low to high</button></li>
                        <li><button type="button" class="dropdown-item">Price: high to low</button></li>
                        <li><button type="button" class="dropdown-item">Largest area</button></li>
                    </ul>
                </div>
                <div class="listing-toolbar__views" role="group" aria-label="Listing layout">
                    <button type="button" class="listing-toolbar__view-btn" data-listing-view="list"
                ...
                <article class="property-card property-card--listing">
                    ...
                    <div class="property-card__inner">
                        <div class="property-card__media">
                            ...
                            <picture>
                                <img src="public/images/properties/1.jpg" alt="Majestic Tower" width="427" height="260"
                                    loading="lazy">
                            </picture>
                            <picture>
                                <img src="public/images/properties/1.jpg" alt="Majestic Tower" width="427" height="260"
            ...
            <div class="properties-col">
                ...
                <article class="property-card property-card--listing">
                    ...
                    <div class="property-card__inner">
                        <div class="property-card__media">
                            <picture>
                                <img src="public/images/properties/3.jpg" alt="Palm Heights" width="427" height="260"
                                    loading="lazy">
                            </picture>
                            <picture>
                                <img src="public/images/properties/3.jpg" alt="Palm Heights" width="427" height="260"
