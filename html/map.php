...
?>
    ...
    <section class="properties-listing ">
        ...
        <div class="map-page-hero" aria-label="Properties map">
            <picture>
                <img src="public/images/map-page.png" alt="Map view of available properties in Dubai" width="1920" height="712" loading="lazy">
            </picture>
        </div>
    </section>
