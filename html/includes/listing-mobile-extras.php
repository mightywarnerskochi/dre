    ...
    <div class="offcanvas offcanvas-bottom listing-search-offcanvas" tabindex="-1" id="listingSearchOffcanvas"
        ...
        <div class="offcanvas-header listing-search-offcanvas__header">
            <h2 class="offcanvas-title h5 mb-0" id="listingSearchOffcanvasLabel">Search properties</h2>
    ...
    <div class="offcanvas offcanvas-bottom listing-sort-offcanvas" tabindex="-1" id="listingSortOffcanvas"
        ...
        <div class="offcanvas-body listing-sort-offcanvas__body">
            <div class="listing-sort-offcanvas__options" role="list">
                <button type="button" class="listing-sort-offcanvas__opt is-active" data-bs-dismiss="offcanvas">Newest first</button>
                <button type="button" class="listing-sort-offcanvas__opt" data-bs-dismiss="offcanvas">Price: low to high</button>
                <button type="button" class="listing-sort-offcanvas__opt" data-bs-dismiss="offcanvas">Price: high to low</button>
    ...
    <nav class="listing-mobile-bar" aria-label="Property listing tools">
        ...
        <a href="https://www.google.com/maps/search/?api=1&amp;query=Dubai+UAE+properties" class="listing-mobile-bar__action listing-mobile-bar__action--link" target="_blank" rel="noopener noreferrer">
        ...
        <div class="listing-mobile-bar__views" role="group" aria-label="Listing layout">
            <button type="button" class="listing-mobile-bar__view-btn" data-listing-view="list" aria-label="List view" aria-pressed="false">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <button type="button" class="listing-mobile-bar__view-btn is-active" data-listing-view="grid" aria-label="Grid view" aria-pressed="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
