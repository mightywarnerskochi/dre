<!-- Listing: mobile search (bottom sheet) -->
<div class="offcanvas offcanvas-bottom listing-search-offcanvas" tabindex="-1" id="listingSearchOffcanvas"
    aria-labelledby="listingSearchOffcanvasLabel">
    <div class="offcanvas-header listing-search-offcanvas__header">
        <h2 class="offcanvas-title h3 mb-0" id="listingSearchOffcanvasLabel">Search properties</h2>
...
<!-- Listing: mobile sort -->
<div class="offcanvas offcanvas-bottom listing-sort-offcanvas" tabindex="-1" id="listingSortOffcanvas"
    aria-labelledby="listingSortOffcanvasLabel">
    <div class="offcanvas-header listing-sort-offcanvas__header">
        <h2 class="offcanvas-title h3 mb-0" id="listingSortOffcanvasLabel">Sort by</h2>
    ...
    <div class="offcanvas-body listing-sort-offcanvas__body">
        <div class="listing-sort-offcanvas__options" role="list">
            <button type="button" class="listing-sort-offcanvas__opt is-active" data-bs-dismiss="offcanvas">Newest
                first</button>
            <button type="button" class="listing-sort-offcanvas__opt" data-bs-dismiss="offcanvas">Price: low to
                high</button>
            <button type="button" class="listing-sort-offcanvas__opt" data-bs-dismiss="offcanvas">Price: high to
                low</button>
            <button type="button" class="listing-sort-offcanvas__opt" data-bs-dismiss="offcanvas">Largest area</button>
        </div>
    </div>
</div>

<nav class="listing-mobile-bar" aria-label="Property listing tools">
    <button type="button" class="listing-mobile-bar__action" data-bs-toggle="offcanvas"
        data-bs-target="#listingSearchOffcanvas" aria-controls="listingSearchOffcanvas">
    ...
    <a href="https://www.google.com/maps/search/?api=1&amp;query=Dubai+UAE+properties"
        class="listing-mobile-bar__action listing-mobile-bar__action--link" target="_blank" rel="noopener noreferrer">
    ...
    <div class="listing-mobile-bar__views" role="group" aria-label="Listing layout">
        <button type="button" class="listing-mobile-bar__view-btn" data-listing-view="list" aria-label="List view"
            aria-pressed="false">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                aria-hidden="true">
                <path
        ...
        <button type="button" class="listing-mobile-bar__view-btn is-active" data-listing-view="grid"
            aria-label="Grid view" aria-pressed="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                aria-hidden="true">
                <path
                    d="M8.885 10.5H5.615C5.155 10.5 4.771 10.346 4.463 10.038C4.155 9.73 4.00067 9.34567 4 8.885V5.615C4 5.155 4.15433 4.771 4.463 4.463C4.77167 4.155 5.156 4.00067 5.616 4H8.885C9.345 4 9.72933 4.15433 10.038 4.463C10.3467 4.77167 10.5007 5.156 10.5 5.616V8.885C10.5 9.345 10.346 9.72933 10.038 10.038C9.73 10.3467 9.34567 10.5007 8.885 10.5Z"
                    fill="currentColor" />
                <path
                    d="M18.385 10.5H15.115C14.655 10.5 14.271 10.346 13.963 10.038C13.655 9.73 13.5007 9.34567 13.5 8.885V5.615C13.5 5.155 13.6543 4.771 13.963 4.463C14.2717 4.155 14.656 4.00067 15.116 4H18.385C18.845 4 19.2293 4.15433 19.538 4.463C19.8467 4.77167 20.0007 5.156 20 5.616V8.885C20 9.345 19.846 9.72933 19.538 10.038C19.23 10.3467 18.8463 10.5007 18.385 10.5Z"
                    fill="currentColor" />
                <path
                    d="M8.885 20H5.615C5.155 20 4.771 19.846 4.463 19.538C4.155 19.23 4.00067 18.8453 4 18.384V15.116C4 14.6553 4.15433 14.271 4.463 13.963C4.77167 13.655 5.156 13.5007 5.616 13.5H8.885C9.345 13.5 9.72933 13.6543 10.038 13.963C10.3467 14.2717 10.5007 14.656 10.5 15.116V18.385C10.5 18.845 10.346 19.2293 10.038 19.538C9.73 19.8467 9.34567 20.0007 8.885 20Z"
                    fill="currentColor" />
                <path
                    d="M18.385 20H15.115C14.655 20 14.271 19.846 13.963 19.538C13.655 19.23 13.5007 18.8453 13.5 18.384V15.116C13.5 14.6553 13.6543 14.271 13.963 13.963C14.2717 13.655 14.656 13.5007 15.116 13.5H18.385C18.845 13.5 19.2293 13.6543 19.538 13.963C19.8467 14.2717 20.0007 14.656 20 15.116V18.385C20 18.845 19.846 19.2293 19.538 19.538C19.23 19.8467 18.8463 20.0007 18.385 20Z"
                    fill="currentColor" />
            </svg>
        </button>
    </div>
    <button type="button" class="listing-mobile-bar__action" data-bs-toggle="offcanvas"
        data-bs-target="#listingSortOffcanvas" aria-controls="listingSortOffcanvas">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
            aria-hidden="true">
