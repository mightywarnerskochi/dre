        ...
        <div class="banner--page__content">
            <div class="container-ctn">
                ...
                <ol class="breadcrumb-minimal" aria-label="Breadcrumb">
                    ...
                    <li><a href="/our-property">Property</a></li>
                    <li class="breadcrumb-minimal__sep" aria-hidden="true">/</li>
                ...
                <div class="property-detail-gallery__viewport">
                    <div class="property-detail-gallery__slider js-property-detail-slider">
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--portrait">
                            <img :src="asset('public/images/properties-details/1.jpg')" alt="Bathroom" width="520" height="780" loading="lazy">
                        </div>
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--wide">
                            <img :src="asset('public/images/properties-details/2.jpg')" alt="Living and dining area" width="960" height="600" loading="lazy">
                        </div>
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--landscape">
                            <img :src="asset('public/images/properties-details/3.jpg')" alt="Bedroom" width="880" height="560" loading="lazy">
                        </div>
                        <div class="property-detail-gallery__slide property-detail-gallery__slide--wide">
                            <img :src="asset('public/images/properties-details/1.jpg')" alt="Living room with floor-to-ceiling windows" width="960" height="600" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="property-detail-agent__header">
                                    <div class="property-detail-agent__profile">
                                        <div class="property-detail-agent__avatar">
                                            <img :src="asset('public/images/chat.png')" alt="" width="64" height="64" loading="lazy">
                                        </div>
                ...
                <section class="property-detail-section" aria-labelledby="pd-access-heading">
                    ...
                    <div class="property-detail-access">
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/lets-icons_road-alt.png')" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Academic City  7 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/mynaui_plane.png')" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai International Airport (DXB): 17 min</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/icon-park-outline_shopping-mall.png')" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai Outlet Mall 8 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/fluent-emoji-high-contrast_man-playing-handball.png')" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Dubai Rugby Sevens 10 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/material-symbols_hiking.png')" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Al Qudra Cycling Track 13 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/streamline-cyber_building-13.png')" alt="" width="22" height="22" loading="lazy"></span>
                            <span>Expo City Dubai 15 mins</span>
                        </div>
                        <div class="property-detail-access__item">
                            <span class="property-detail-access__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/solar_city-linear.png')" alt="" width="22" height="22" loading="lazy"></span>
                ...
                <section class="property-detail-section" aria-labelledby="pd-specs-heading">
                    ...
                    <div class="property-detail-specs property-detail-specs--cards">
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/solar_tag-price-linear.png')" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Property Id:</p>
                            <p class="property-detail-specs__value">19912</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/solar_hand-money-outline.png')" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Price</p>
                            <p class="property-detail-specs__value">45,000 د.إ</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/gis_square-pt.png')" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Property Size</p>
                            <p class="property-detail-specs__value">580 ft²</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/cil_bathroom.png')" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Bathroom</p>
                            <p class="property-detail-specs__value">1</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/mynaui_calendar.png')" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Year Built</p>
                            <p class="property-detail-specs__value">2021-06-30</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/fluent_building-32-regular.png')" alt="" width="24" height="24" loading="lazy"></span>
                            <p class="property-detail-specs__label">Direct from owner</p>
                            <p class="property-detail-specs__value">Studio</p>
                        </div>
                        <div class="property-detail-specs__cell">
                            <span class="property-detail-specs__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/ph_hand-deposit.png')" alt="" width="24" height="24" loading="lazy"></span>
                ...
                <section class="property-detail-section" aria-labelledby="pd-features-heading">
                    ...
                    <div class="property-detail-icon-grid">
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/tabler_device-cctv.png')" alt="" width="26" height="26" loading="lazy"></span>
                            <span>4-hour security</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/bx_car.png')" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Car Parking</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/iconoir_gym.png')" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Gym</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/solar_swimming-outline.png')" alt="" width="26" height="26" loading="lazy"></span>
                    ...
                    <div class="property-detail-icon-grid property-detail-icon-grid--cols3">
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/hugeicons_car-parking-01.png')" alt="" width="26" height="26" loading="lazy"></span>
                            <span>Covered Parking</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/solar_hand-money-outline.png')" alt="" width="26" height="26" loading="lazy"></span>
                            <span>No Commission</span>
                        </div>
                        <div class="property-detail-icon-grid__item">
                            <span class="property-detail-icon-grid__icon" aria-hidden="true"><img :src="asset('public/images/properties-details/icons/hugeicons_location-star-01.png')" alt="" width="26" height="26" loading="lazy"></span>
                    ...
                    <div class="property-detail-map-card__map-panels js-map-map-panels" aria-live="polite">
                        <div id="map-panel-schools" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-schools" hidden>
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" :src="asset('public/images/properties-details/map.jpg')" alt="Map showing schools near the property" width="560" height="360" loading="lazy">
                                ...
                                <div class="property-detail-map-card__popup js-map-popup" role="dialog" aria-label="Property summary">
                                    ...
                                    <img class="property-detail-map-card__popup-thumb" :src="asset('public/images/properties-details/1.jpg')" alt="" width="64" height="64" loading="lazy">
                        ...
                        <div id="map-panel-hospitals" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-hospitals" hidden>
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" :src="asset('public/images/properties-details/map.jpg')" alt="Map showing hospitals near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                    <span class="property-detail-map-card__pin-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M3 10.5L12 3L21 10.5V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V10.5Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div id="map-panel-restaurants" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-restaurants" hidden>
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" :src="asset('public/images/properties-details/map.jpg')" alt="Map showing restaurants near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                    <span class="property-detail-map-card__pin-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M3 10.5L12 3L21 10.5V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V10.5Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div id="map-panel-attractions" class="property-detail-map-card__map-panel" role="tabpanel" aria-labelledby="map-tab-attractions">
                            <div class="property-detail-map-card__frame">
                                <img class="property-detail-map-card__img" :src="asset('public/images/properties-details/map.jpg')" alt="Map showing attractions near the property" width="560" height="360" loading="lazy">
                                <div class="property-detail-map-card__pin" aria-hidden="true">
                                    <span class="property-detail-map-card__pin-dot">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                            <path d="M3 10.5L12 3L21 10.5V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V10.5Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="container-ctn">
                ...
                <div class="property-detail-similar__slider-outer">
                    <div class="js-property-detail-similar-slider property-detail-similar__slider">
                        <div v-for="p in similarListings" :key="p.t" class="property-detail-similar__slide">
                            <article class="property-card property-card--listing">
                                ...
                                <div class="property-card__inner">
                                    <div class="property-card__media">
                                        ...
                                        <div v-for="n in 6" :key="n" class="property-card__media-slide">
                                            <picture>
                                                <img :src="asset('public/images/properties/' + p.img + '.jpg')" :alt="p.t" width="427" height="260" loading="lazy">
                                            </picture>
                                        </div>
                                    ...
                                    <div class="property-card__body">
                                        <h3 class="property-card__title">{{ p.t }}</h3>
                                        ...
                                        <div class="property-card__meta property-card__meta--similar">
                                            <div class="property-card__price-row">
                                                <div class="property-card__price">{{ p.price }} د.إ</div>
                                            </div>
                                        ...
                                        <div class="property-details">
                                            <div class="property-details__item">
                                                ...
                                                <span>{{ p.bed }} Bedroom{{ p.bed === 1 ? '' : 's' }}</span>
                                            </div>
                                            <div class="property-details__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                                ...
                                                <span>{{ p.bath }} Bathroom{{ p.bath === 1 ? '' : 's' }}</span>
                                            </div>
                                            <div class="property-details__item">
