    ...
    <div class="offcanvas offcanvas-end mobile_left_menu" tabindex="-1" id="burgerMenu" aria-labelledby="mobileOffcanvasLabel" aria-modal="true" role="dialog">
        ...
        <div class="offcanvas-body mobile-menu__body">
            ...
            <div class="footer">
                ...
                <ul class="mobile-menu__social" :aria-label="t('followUs.socialAria')">
                    <li>
                        <a href="#" :aria-label="t('followUs.facebook')" class="mobile-menu__social-link">
                    ...
                    <li>
                        <a href="#" :aria-label="t('followUs.twitter')" class="mobile-menu__social-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <li>
                        <a href="#" :aria-label="t('followUs.linkedin')" class="mobile-menu__social-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <li>
                        <a href="#" :aria-label="t('followUs.instagram')" class="mobile-menu__social-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <li>
                        <a href="#" :aria-label="t('followUs.youtube')" class="mobile-menu__social-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <li>
                        <a href="https://wa.me/971503697355" :aria-label="t('nav.whatsapp')" class="mobile-menu__social-link" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path
