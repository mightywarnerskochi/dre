...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3"><h5 class="mb-0">Add Why Choose Us Item</h5></div>
    <div class="card-body p-4">
        ...
        @endif
        <form action="{{ route('cms.why-choose-us.store') }}" method="POST">
            @csrf
            ...
            @php($item = new \App\Models\CmsKit\WhyChooseUs())
