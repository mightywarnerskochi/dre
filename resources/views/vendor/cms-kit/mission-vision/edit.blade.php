...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3"><h5 class="mb-0">Edit Mission & Vision Item</h5></div>
    <div class="card-body p-4">
        ...
        @endif
        <form action="{{ route('cms.mission-vision.update', $item->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
